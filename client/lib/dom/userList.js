...
function createUserCard({ id = '', name = 'tiger', email = 'tiger@gmail.com', website = 'tiger.com' }) {
  const template = /* html */ `
...
function createSpinner(size = 100, loadingMessage = '로딩중') {
  return /*html*/ ` 
