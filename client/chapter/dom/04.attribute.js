...
first.hasAttribute('title'); //false
first.hasAttribute('id'); //true
first.hasAttribute('class'); //true

first.getAttribute('id'); // message

first.setAttribute('title', '메세지');
first.setAttribute('class', 'second'); // 클래스를 변경하는 것은 위험
